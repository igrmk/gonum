...
// These exist because cmplx.Sinh, cmplx.Cosh and cmplx.Tanh return NaN for Inf.
...
func same(a, b complex128, tol float64) bool {
	return (cmplx.IsNaN(a) && cmplx.IsNaN(b)) || (cmplx.IsInf(a) && cmplx.IsInf(b)) || equalApprox(a, b, tol)
}
